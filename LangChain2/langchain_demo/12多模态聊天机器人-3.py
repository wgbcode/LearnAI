...
# 最终的链
# RunnablePassthrough 默认会将输入数据原样传递到下游，而 .assign() 方法允许在保留原始输入的同时，通过指定键值对（如 messages_summarized=summarize_messages）向输入字典中添加新字段
...
result3 = final_chain.invoke({'input': '历史上，和我同名的人有哪些？', "config": {"configurable": {"session_id": "user123"}}},
                                            config={"configurable": {"session_id": "user123"}})
print(result3)
